...
public class SimilarTerms {
    ...
    static class Vector{
        ...
        double cosine_sim(TermsClusters.Vector v2) {
    ...
    private static TermsClusters.Vector word2vec(String word) {
        ...
        return new TermsClusters.Vector(counter,charSet,length,word);
    }
    ...
    public static void main(String[] args) {
        ...
        parseArguments(args);
        TermsClusters.Vector v1 = word2vec(term);
        ...
        try {
            ...
            for(int i = 0; i<reader.maxDoc();i++) {
                ...
                while ((text = termsEnum.next()) != null) {
                    ...
                    TermsClusters.Vector v2 = word2vec(term);
